...
> 에이전트가 자기 자신을 인식하고, 세션을 넘어 기억·지식을 축적하는 구조를 연구하고 OFFCODE에 이식한다.
...
└── apply/                       # OFFCODE 적용 설계 (Phase 2 이후)
```
...
4. OFFCODE의 시지푸스/프로메테우스/아틀라스 등이 각자 자기 역할·히스토리·능력을 인식하려면 어떻게 이식해야 하는가?
...
- **로컬 우선**: 외부 API 의존 금지. OFFCODE 원칙과 일치.
